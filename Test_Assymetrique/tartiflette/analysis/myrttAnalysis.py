...
def processInit():
    global db
    client = pymongo.MongoClient("mongodb://ibis:aqw@ds013004.mlab.com:13004/tartiflette",connect=True)
    # client = pymongo.MongoClient("10.206.116.235",connect=True)
    db = client.tartiflette
...
def detectRttChangesMongo(expId=None):
    ...
    client = pymongo.MongoClient("mongodb://ibis:aqw@ds013004.mlab.com:13004/tartiflette")
    db = client.tartiflette
    ...
    if expId is None:
        expParam = {
                ...
                "start": datetime(2017, 6, 28, 8, 31, tzinfo=timezone("Europe/Paris")),
                "end":   datetime(2017, 6, 28, 8, 51, tzinfo=timezone("Europe/Paris")),
                "alpha": 0.01,
                "confInterval": 0.05,
                "minASN": 0,
                "minASNEntropy": 0.5,
